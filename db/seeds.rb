...
laser1 = Weapon.find_or_create_by(name: "Laser lv 1", damage_level: 1, dangerous: false)
laser2 = Weapon.find_or_create_by(name: "Laser lv 2", damage_level: 2, dangerous: false)
laser3 = Weapon.find_or_create_by(name: "Acme Mega Laser", damage_level: 3, dangerous: true)
laser4 = Weapon.find_or_create_by(name: "Master Laser", damage_level: 4, dangerous: false)
fist = Weapon.find_or_create_by(name: "Fist", damage_level: 0, dangerous: false)
space_revolover = Weapon.find_or_create_by(name: "Space Revolver", damage_level: 2, dangerous: false)
acme_shotgun = Weapon.find_or_create_by(name: "Acme Shotgun", damage_level: 4, dangerous: true)
grenade = Weapon.find_or_create_by(name: "Acme Grenade Launcher", damage_level: 5, dangerous: true)
rocket_launcher = Weapon.find_or_create_by(name: "Rocket Launcher", damage_level: 5, dangerous: false)
flame_thrower = Weapon.find_or_create_by(name: "Flame_Thrower", damage_level: 3, dangerous: false)
knife_gun = Weapon.find_or_create_by(name: "Knife Gun", damage_level: 3, dangerous: false)
acme_lightsword = Weapon.find_or_create_by(name: "Acme Lightsword", damage_level: 5, dangerous: true)
gravity_beam = Weapon.find_or_create_by(name: "Gravity Beam", damage_level: 4, dangerous: true)
laser_crossbow = Weapon.find_or_create_by(name: "Laser Crossbow", damage_level 2, dangerous: false)
