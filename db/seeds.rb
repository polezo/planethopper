...
zb931 = Planet.find_or_create_by(name: "New Earth",bad_scenario: "You've encountered a frog with a laser!", good_scenario: "You found a good thing! Your health is increased")
...
earth2 = Planet.find_or_create_by(name: "ZB-937",bad_scenario: "You've encountered a blob with a laser!", good_scenario: "You got some medicine! Your health is increased")
